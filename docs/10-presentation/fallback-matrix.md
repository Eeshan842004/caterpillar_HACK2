...
> **Source:** [`PRESENTATION_SYSTEM_PLAN.md`](file:///c:/Users/kriss/github/caterpillar-hack/caterpillar-hack/PRESENTATION_SYSTEM_PLAN.md) Section 14.
...
| **Judge Asks to Inspect Code / Proof** | Technical deep-dive challenge | Open `tests/e2e-hero-path.test.ts` and run `npx vitest run`. Show 36 passing tests in 2.3 seconds. | < 5 seconds |
