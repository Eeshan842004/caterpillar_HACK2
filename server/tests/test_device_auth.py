...
def test_device_auth_security(client):
    ...
    headers_skew = make_device_auth_headers(
        "GET", path, b"", device_id, device_secret, timestamp_ms=skewed_ts
    )
    ...
    # 4. Unknown device
    headers_unknown = make_device_auth_headers(
        "GET", path, b"", "00000000-0000-0000-0000-000000000000", device_secret
    )
